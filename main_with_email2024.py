...
sender_email = "xxxx@gmail.com"    #寄件人  
password = "zmhjdbzsxxx"        #寄信密碼
cc_emails = ["ffffff@gmail.com"]  # CC 收件人清單
...
def send_summary_via_email(summary, recipient_email, subject="摘要結果"):
    try:
        ...
        message["CC"] = ", ".join(cc_emails)  # 添加 CC 收件人
        ...
        with smtplib.SMTP_SSL(smtp_server, port) as server:
            ...
            server.sendmail(
                sender_email, 
                [recipient_email] + cc_emails,  # 添加收件人與 CC 收件人
                message.as_string()
            )
